<%@ Page Title="" Language="C#" MasterPageFile="~/m_ClientMaster.master" AutoEventWireup="true" CodeFile="p_ClientPage.aspx.cs" Inherits="p_ClientPage" %>
  ...
  i {
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <ej:Grid ID="Grid1" runat="server" AllowPaging="True" OnServerEditRow="EditEvents_ServerEditRow" OnServerAddRow="EditEvents_ServerAddRow"
                                ...
                                <Columns>
                                    <ej:Column Field="d_id" HeaderText="PackageID" Visible="false" IsPrimaryKey="true" TextAlign="Right" Width="90">
                    <ValidationRule>
                ...
                <ej:Column Field="D_AttorneyMatterRef" HeaderText="Attorney Matter Ref" IsPrimaryKey="true" TextAlign="Right" Width="50">

                </ej:Column>

                <ej:Column Field="D_PlaintiffInitial" HeaderText="Plaintiff Initial" Width="70" />
    ...
    <div style="margin: 5px auto auto 50px; width: 2000px;">
        <ej:Grid ID="OrdersGrid" AllowSorting="True" runat="server" AllowPaging="True" OnServerEditRow="EditEvents_ServerEditRow"
            ...
            Width="10" OnServerExcelExporting="OrdersGrid_ServerExcelExporting" AllowResizeToFit="True">
            <ToolbarSettings ShowToolbar="True" ToolbarItems="add,edit,excelExport,delete"></ToolbarSettings>

            <ClientSideEvents ActionComplete="complete" EndAdd="endAdd" EndDelete="endDelete" EndEdit="endEdit" />
            <Columns>

                <ej:Column Field="d_AccountNumber" HeaderText="Account Number 1" Width="50" Visible="false" />
